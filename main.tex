...
\blue{\textbf{Cell 2: Low action cost, high inaction cost $\rightarrow$ vigorous evacuation.}} When action is cheap but inaction is politically costly, the cost-benefit calculus overwhelmingly favors a forceful response. \blue{The U.S.\ response to the 2023 Israel crisis, analyzed in Section~4.1, illustrates this cell: commercial routes remained open (low action cost), but the political salience of the crisis and 27 American casualties created intense pressure to act (high inaction cost).}
...
\blue{\textbf{Cell 4: High action cost, high inaction cost $\rightarrow$ indeterminate.}} \blue{This is the theoretically most interesting and empirically most consequential cell. When both dimensions push in opposing directions, the outcome depends on which cost dominates---a determination shaped by leader preferences, institutional constraints, and the relative weight of domestic versus international considerations. The U.K.\ response to the 2011 Libya crisis, analyzed in Section~4.2, falls in this cell: evacuation was logistically difficult, but media criticism forced the government's hand. I return to this cell in the conclusion as a priority for future research.}
